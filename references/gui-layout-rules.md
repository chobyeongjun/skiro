...
|----|---------|-------------|------|
| G01 | Natural Language → Layout Command Mapping | move, swap, center, resize, hide, 붙여줘, 접어줘 | 15 |
| G02 | Framework-Specific Layout Patterns | pyqt, tkinter, css, flutter, layout | 76 |
| G03 | Overlap Prevention Checklist | overlap, minimumSize, scroll, responsive | 135 |
| G04 | Design Consistency Checklist | spacing, color, typography, theme | 150 |

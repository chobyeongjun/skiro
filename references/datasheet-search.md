...
|----|---------|-------------|------|
| DS01 | Search Strategy | datasheet, search, query | 17 |
| DS02 | Motor / Actuator Specs | motor, torque, actuator, gear_ratio, max_velocity | 23 |
| DS03 | Sensor Specs | sensor, imu, sample_rate, range, resolution | 51 |
| DS04 | Camera Specs | camera, resolution, fps, depth, stereo | 71 |
| DS05 | MCU Specs | mcu, clock, ram, flash, arduino, stm32, esp32 | 89 |
| DS06 | Verification Checklist | verify, units, cross-reference | 109 |

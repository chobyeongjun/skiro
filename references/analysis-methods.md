...
|----|---------|-------------|------|
| A01 | Control Performance Metrics | rmse, settling_time, bandwidth | 16 |
| A02 | Frequency Analysis | fft, psd, welch, bode | 51 |
| A03 | Trajectory Analysis | jerk, smoothness, work, energy | 78 |
| A04 | Statistical Tests | t-test, anova, wilcoxon, shapiro | 99 |
| A05 | Paper-Ready Output | matplotlib, latex, table, figure | 154 |

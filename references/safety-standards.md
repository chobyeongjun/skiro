...
| Section | 표준 | 적용 대상 | Line |
|---------|------|----------|------|
| ISO-10218 | 산업용 로봇 안전 | 산업용 로봇, 안전 기능 | 35 |
| ISO-15066 | 협동 로봇 안전 | 협동 로봇, 힘/속도 제한 | 154 |
| SS04-PFL | PFL 힘/압력 한계 | 접촉 힘 제한 설계 | 171 |
| SS05-SSM | SSM 속도-거리 | 속도/거리 안전 모니터링 | 210 |
| SS06 | 충돌 에너지 제한 | 에너지 기반 안전 검증 | 241 |
| ISO-13482 | 개인 케어 로봇 | 재활/보조 로봇 | 269 |
| IEC-61508 | 기능 안전 | SIL 등급, 안전 함수 | 360 |
| ISO-13849 | 안전 제어 시스템 | PL 등급, 이중화 구조 | 462 |
| CODE-CHECK | 코드 레벨 체크리스트 | 안전 검증 grep 명령 | 540 |

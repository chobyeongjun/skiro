...
| ID | 패턴 | 카테고리 | Line |
|----|------|---------|------|
| S01 | 양정치 조건 위반 | 패시비티 | 78 |
| S02 | 감쇠비 부족 | 패시비티 | 104 |
| S03 | 가상 관성이 너무 작음 | 패시비티 | 138 |
| S04 | 샘플링 주기와 임피던스 대역폭 불일치 | 이산화 | 159 |
| S05 | 오일러 적분 불안정 | 이산화 | 204 |
| S06 | 힘 센서 지연 미보상 | 이산화 | 227 |
| S07 | 환경 임피던스와의 커플링 불안정 | 커플링 | 249 |
| S08 | 비선형 마찰 보상 오류 | 커플링 | 278 |
| S09 | 가속도 수치 미분의 노이즈 | 구현 버그 | 359 |
| S10 | 힘/토크 센서 드리프트 미보상 | 구현 버그 | 380 |
| S11 | 좌표계 불일치 | 구현 버그 | 400 |
| S12 | 모드 전환 시 불연속 | 구현 버그 | 421 |

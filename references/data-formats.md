...
| ID | Section | 트리거 키워드 | Line |
|----|---------|-------------|------|
| DF01 | CSV Data | csv, delimiter, header, sample_rate | 20 |
| DF02 | ROS Bag Data | rosbag, ros2 bag, mcap, db3 | 64 |
| DF03 | HDF5 Data | h5py, hdf5, .h5 | 98 |
| DF04 | MATLAB .mat Data | loadmat, .mat, scipy.io, h5py | 114 |
| DF05 | EDF/BDF | edf, bdf, mne, pyedflib, biosignal | 164 |
| DF06 | MCAP | mcap, ros2, read_ros2_messages | 220 |
| DF07 | Serial Data Capture | serial, pyserial, uart, baudrate | 273 |
| DF08 | File Naming Convention | naming, directory, file structure | 294 |
| DF09 | Integrity Report Format | validation, integrity, report | 317 |
